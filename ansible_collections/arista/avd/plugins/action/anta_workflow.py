...
if TYPE_CHECKING:
    ...
    from pyavd._anta.models import MinimalStructuredConfig
...
try:
    ...
    from pyavd.api._anta import AvdCatalogGenerationSettings, get_fabric_data
...
FABRIC_DATA: dict[str, MinimalStructuredConfig] | None = None
...
def build_anta_runner_objects(devices: list[str]) -> tuple[ResultManager, AntaInventory, AntaCatalog]:
    ...
    allow_bgp_vrfs = get(PLUGIN_ARGS, "avd_catalogs.allow_bgp_vrfs")
