...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;validate_bgp_peers</samp>](## "router_bgp.vrfs.[].validate_bgp_peers") | Boolean |  | `False` |  | Set to true to enable BGP peers validation for the VRF performed by the `anta_runner` role. |
