...
class AntaTestInputFactory(ABC, Generic[Input]):
    ...
    def is_peer_available(self, peer: str, identity: str) -> bool:
        ...
        if peer not in self.fabric_data or not self.fabric_data[peer].is_deployed:
    ...
    def get_interface_ip(self, peer: str, peer_interface: str, interface: str) -> str | None:
        ...
        for intf in self.fabric_data[peer].ethernet_interfaces:
    ...
    def is_peer_interface_shutdown(self, peer: str, peer_interface: str, interface: str) -> bool | None:
        ...
        """
        peer_intf = next((intf for intf in self.fabric_data[peer].ethernet_interfaces if intf.name == peer_interface), None)
